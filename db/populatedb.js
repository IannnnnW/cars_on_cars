     ...
     for( const car of cars){
      ...
      for (const car of cars) {
        ...
        const carResult = await client.query(
          'INSERT INTO cars (brand, model, year, asset) VALUES ($1, $2, $3, $4) RETURNING id',
          [car.brand, car.model, car.year, car.car_asset]
        );
